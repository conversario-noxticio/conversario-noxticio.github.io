...
const cards = [
        ...
        options: [
            {
                ...
                info: "Tomas el martillo sin saber muy bien por qué. El espíritu te observa satisfecho. " +
                    ...
                    "y desaparece. <b> Pierdes una carta aleatoria de tu mano. </b> <i> Deja esta carta y otra de tu mano en " +
            ...
            },
            {
                ...
                info: "Aceptas su propuesta y finges trabajar junto a él. El calor es insoportable, y el espíritu " +
                    ...
                    "Escapas ardiendo, pero con el botín. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu " +
                    "aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "La visión te supera. El calor, la mirada del espíritu, las llamas... todo es demasiado. " +
                    ...
                    "risa cavernosa antes de volver a golpear el yunque. <b> No ocurre nada. Sigues tu camino. </b> <i> Deja la " +
        ...
        options: [
            {
                ...
                info: "Si tienes una carta de ataque en tu mano obtienes la carta, sino déjala en el mazo de " +
                    "descarte. <b> Obtienes la carta si tienes una carta de ataque en tu mano. Sino descártala. </b> " +
        ...
        options: [
            {
                ...
                info: "Un espíritu sale de la piedra y te da la espada de Elduara. Un arma ancestral que te " +
                    "protegerá de algunos peligros. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu " +
                    "aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Un espíritu enfadado sale y te lanza una maldición mientras escuchas: \"Respeta a tus mayores\". " +
                    "Sales del bosque. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "El mercader te entrega el amuleto sin emoción alguna. Al colocártelo, sientes un leve hormigueo, " +
                    ...
                    "decisiones que no tomaste. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
            ...
            },
            {
                ...
                info: "El mercader sonríe por primera vez mientras coloca la daga en tus manos. " +
                    ...
                    "<b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "El mercader te observa fijamente mientras tomas el frasco. Al beber el líquido, " +
                    ...
                    "como humo, dejándote solo en la oscuridad. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "El apóstol peregrino nota que te resistes, te considera un enemigo y decide atacarte. " +
                    "<b> Pierdes una carta aleatoria de tu mano y también esta carta. </b> <i> Deja la carta aleatoria y esta " +
                    "en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "La figura te guía hacia la salida de ese paraje oscuro y te cuenta sobre un amuleto que se " +
                    ...
                    "entrega del amuleto, pues considera que puede hacerte bien. <b> Obtienes la carta. </b> <i> Guárdala en " +
        ...
        options: [
            {
                ...
                info: "La anciana se ríe a carcajadas y se marcha pronunciando palabras incognoscibles. " +
                    "No ocurre nada. Eso era lo que querías, ¿o no? <b> Pierdes la carta. </b> <i> Deja la carta en el " +
        ...
        options: [
            {
                ...
                info: "Pataleas hasta encontrar un borde firme. Sales del agua jadeando. " +
                    ...
                    "No sabes qué es y no sabes si se irá. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Hundes la mano en el agua con decisión. Algo muerde. Tiras, y la criatura emerge " +
                    ...
                    "si se ha dejado atrapar. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Cierras los ojos. Las palabras salen solas, sin sentido. La criatura se detiene " +
                    ...
                    "entre las aguas. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "No puedes evitarlo. El calor se mezcla con el agua, y eso basta. " +
                    ...
                    "clavarse más allá de la piel. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Con determinación, intentas romper el sello. Cuando lo logras, una energía oscura surge del " +
                    ...
                    "pasaje que brilla intensamente. \"Ahora eres quien porta el conocimiento prohibido.\" <b> Obtienes la carta. " +
            ...
            },
            {
                ...
                info: "Guardas el libro cuidadosamente, esperando encontrar la forma de descifrar su contenido más adelante. " +
                    ...
                    "El libro desaparece de tu bolsa sin dejar rastro. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "La coges en brazos y te dispones a trasportarla, pero nada mas cargarla te muerde el abdomen. " +
                    ...
                    "del río. Despiertas sofocado. Solo había sido una pesadilla. <b> Pierdes la carta. </b> <i> Deja la carta " +
                    "en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Desconfías. Te vas mientras escuchas los gritos de ese ser marino malvado que quería " +
                    "comerse tus entrañas. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
    ...
    },
    {
        ...
        options: [
            {
                text: "Atacar",
                info: "Te avalanzas contra ese ser, pero te lanza contra un árbol y te debilita. <b> Pierdes la carta. " +
                    "</b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "La enorme criatura se marcha a proteger el rebaño y por el camino se le cae un objeto " +
                    "metálico que llevaba entre su pelo. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Comienzas a andar junto a la anciana, te comenta que tiene documentos importantes que no " +
                    ...
                    "Despiertas donde estabas. ¿Era un sueño? <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Prefieres seguir el camino más seguro. La anciana grita de dolor y te ruega que la sigas " +
                    "mientras su cuerpo se convierte en una estatua de sal. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
    ...
    },
    {
        ...
        options: [
            {
                text: "Tirar moneda",
                info: "<b> Cara: </b> El lobo te ofrece su protección durante tu viaje. <b> Guarda esta carta y podrás usarla para " +
                    "no perder una carta aleatoria una vez. </b> <i> Cuando la uses deberás descartarla. </i> " +
                    "<b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i> " +
                    "<br> <b> Cruz: </b> El lobo se marcha sin hacerte nada. Devuelve la carta al mazo para que otros viajeros " +
                    "puedan encontrarse con este ser magnífico. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: true,
                save: () => { return coinResult === "CARA"; },
        ...
        options: [
            {
                ...
                info: "Intentas coger su mano, pero la atraviesas como si fuera un fantasma. " +
                    ...
                    "mala fortuna te acecha... <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Te das cuenta de que es una anciana muy afable y bondadosa. Se siente sola debido a aquellas " +
                    ...
                    "ella te guiará. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Miras dentro de tu zurrón, y te avergüenzas de no tener algo del valor suficiente. " +
                    ...
                    "Los dioses lo entienden, tu corazón es puro, y aceptan tu ofrenda. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "La desesperación te consume. No tienes tiempo para más enigmas y acertijos. " +
                    ...
                    "vuelves a estar de pie, al lado del pozo, como si todo hubiese sido un sueño. <b> Pierdes la " +
                    "carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Encuentras una piedra reluciente en el suelo y la lanzas lejos. El sapo gira lentamente " +
                    "la cabeza hacia el destello. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Das unos pasos atrás y estudias a la criatura. Descubres que cada cierto tiempo cierra " +
                    ...
                    "sin problema. <b> Obtienes la carta. </b> <i> Guardala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "El impulso te domina y echas a correr. El sapo no te sigue... pero en el apuro, tropiezas " +
                    "y pierdes algo importante. <b> Pierdes una carta aleatoria de tu mano y también esta carta. " +
                    "</b> <i> Deja la carta aleatoria y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Gritas y das palmadas esperando intimidarlo. El sapo no se asusta. Solo se enfada. " +
                    "El sapo golpea el suelo con fuerza y te hace salir despavorido del lugar. <b> Pierdes la carta. " +
                    "</b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Poco a poco se van encendiendo más fuegos por el camino. Has de seguirlos de cerca, " +
                    ...
                    "¿Era una trampa? <b> Pierdes una carta aleatoria de tu mano y obtienes esta carta. </b> <i> Deja la " +
                    "carta aleatoria en el mazo de descarte y guarda esta en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "No te fías de lo que ves. Crees que puede ser una trampa, así que decides desviarte y no " +
                    ...
                    "¿Era todo un sueño? <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Pagas a la curandera por su remedio. Ella extrae de su bolsa un ungüento que huele a " +
                    ...
                    "precio es dejar ir algo que llevabas contigo. <b> Pierdes una carta a tu elección de tu mano " +
                    "y obtienes esta carta. </b> <i> Deja la carta elegida en el mazo de descarte y esta en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Decides no pagar y te marchas. Rechazas su ayuda, y con ella, la promesa de alivio. " +
                    ...
                    "sacudir. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Aceptas formar parte del aquelarre. Las brujas y brujos caminan a tu lado, compartiendo " +
                    ...
                    "os alcanzará a todos. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Cierras los ojos. Cuando los abres, solo queda el viento. El círculo se ha desvanecido " +
                    "y tu vínculo con lo oculto se disuelve. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "El interior de la posada es cálido y acogedor, decorado con un estilo antiguo y " +
                    ...
                    "pero con un escalofrio que recorre tu cuerpo. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Mientras te alejas, escuchas sus voces detrás de ti, llamándote con dulzura. " +
                    ...
                    "susurrándote que siempre tendrás un lugar a donde volver. <b> Pierdes la carta. " +
                    "</b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Subes las escaleras crujientes hasta llegar al campanario. Allí encuentras una campana " +
                    ...
                    "ha comenzado,\" susurra una voz etérea. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Das vueltas alrededor de la torre, buscando algo fuera de lo común. Notas que las piedras " +
                    ...
                    "aunque nunca miras atrás. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Abres la caja. Y ves en su interior unas palabras talladas \"Ante cualquier malignidad, " +
                    ...
                    "efecto. Pero, al usarla, la perderás. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "La dejas cerrada. No te atreves a tocarla. Quizá por prudencia, o quizá por miedo. " +
                    "Cuando vuelves a mirar, la caja ha desaparecido. <b> Pierdes la carta. </b> <i> Déjala en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Necesitas recibir algún tipo de explicación de quién es esa señora y el porqué te ha dado a " +
                    ...
                    "y cuando miras tus manos ya no tienes el collar. <b> Pierdes la carta. </b> <i> Déjala en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Ves un altar construido con ruinas del lugar y consideras que es perfecto para apreciar mejor " +
                    ...
                    "la salida. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "La idea de cargar con un objeto tan peligroso no te convence. Decides golpearlo con una roca " +
                    ...
                    "algo importante. <b> Pierdes la carta. </b> <i> Déjala en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Ves el espejo como una oportunidad, pero no para usarlo. Decides buscar a alguien dispuesto " +
                    ...
                    "perder una carta. Después de usarlo, tendrás que descartarlo. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Te acercas sigilosamente y coges uno de los frascos. Observas en la etiqueta que cuelga " +
                    ...
                    "guardas en el zurrón y consigues escapar de ahí sin que te vean. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Te armas de valor y, con mucha cautela, sigues sus pasos hasta llegar a unas escaleras " +
                    ...
                    "pero con un extraño dolor de cabeza. ¿Habrá sido todo un sueño?. <b> Pierdes la carta. </b> <i> Déjala en " +
                    "el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "La piedra se acomoda y el castillo expide una melodía gloriosa. El camino se abre de par " +
                    ...
                    "guarda esta carta y úsala como armadura ante los golpes del destino. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "El castillo de naipes de piedra se derrumba y cae encima del sendero causándote graves " +
                    ...
                    "Las cartas ya no son tus aliadas. Continúas tu camino cojeando. <b> Pierdes una carta aleatoria " +
                    "de tu mano y también esta carta. </b> <i> Deja la carta aleatoria y esta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Pierdes una carta a elegir de tu mano. A cambio te quedas esta carta y la bendición del " +
                    "vagabundo. <b> Obtienes la carta. </b> <i> Guárdala en tu mano y descarta otra, si no tienes ninguna " +
                    "pierdes esta. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Al anochecer el lago cambia y se transforma en un portal, donde monstruos deformes te " +
                    ...
                    "una horrible pesadilla. <b> Pierdes una carta aleatoria de tu mano y también esta carta. " +
                    "</b> <i> Deja la carta aleatoria y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Le das parte de tu comida para ese día. Pasarás algo de hambre, pero sobrevivirás. " +
                    "El vagabundo asiente con la cabeza mientras come. <b> Pierdes la carta. </b> <i> Déjala en el mazo " +
                    "de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "En cuanto te vas dejando atrás al vagabundo miras tus pertenencias y descubres que " +
                    "faltan cosas. <b> Pierdes tres cartas aleatorias de tu mano y también esta carta. </b> <i> Deja las " +
                    "cartas aleatorias y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Sacas tu cantimplora y le entregas un poco de agua, manteniéndote alerta. El anciano bebe " +
                    ...
                    "limitado. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Respondes con firmeza que no puedes compartir tu agua y continúas tu camino. El anciano " +
                    ...
                    "salud, el \"anciano\" te ha robado. <b> Pierdes tres cartas aleatorias de tu mano y también " +
                    "esta carta. </b> <i> Deja las cartas aleatorias y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Extiendes una mano hacia el líder, se desfigura tu rostro y te entrega una máscara blanca " +
                    "que debes portar el resto de tu aventura. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Te acurrucas y te ocultas en silencio, cuando la criatura se aleja. Decides aguardar unos " +
                    "minutos más para asegurarte y poder regresar por donde viniste. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Los nervios te invaden. Quieres salir de ahí cuanto antes, parece que estás en el rango " +
                    ...
                    "heridas y habiendo perdido un par de cartas. <b> Pierdes dos cartas aleatorias de tu mano y " +
                    "también esta carta. </b> <i> Deja las cartas aleatorias y esta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Cada respiro se vuelve un desafío, un veneno invisible llena tus pulmones. " +
                    "Tu visión se nubla, tus fuerzas flaquean. <br> Si tienes <b> menos de 10 cartas </b> en tu mano, " +
                    "la niebla consume parte de tu ser. <b> Pierdes una carta aleatoria de tu mano y también " +
                    "esta carta. </b> <i> Deja la carta aleatoria y esta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i> <br> Si tienes <b> 10 o más </b> , logras atravesar el camino sin " +
                    "problema. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Permites que lo que haya en el aire penetre dentro de ti. Te sientes abrumado, confuso y " +
                    ...
                    "No pierdes el tiempo y aceleras el paso, ya que aún te queda aventura por delante. <b> Obtienes " +
                    "la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Decides quedarte inmóvil por un momento, forzando tus sentidos a percibir algo a través " +
                    "de la niebla. Ves cómo se abre ante ti un nuevo camino. <b> Pierdes la carta. </b> <i> Deja la carta en " +
                    "el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            {
                text: "Huir",
                info: "Intentas volver sobre tus pasos, pero solo logras perderte aún más. <b> Pierdes la carta. " +
                    "</b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Niegas con miedo la oferta, pero cuando te quieres dar cuenta, ya estás caminando entre " +
                    ...
                    "de tu mazo, aunque parece que puedes continuar tu aventura. <b> Pierdes una carta aleatoria de " +
                    "tu mano y también esta carta. </b> <i> Deja la carta aleatoria y esta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Agarras el talismán con firmeza. El hombre se queda impresionado con tu actitud y te da las " +
                    ...
                    "ayudarte en tu viaje. <b> Puedes recuperar una carta de evento que hubieses descartado y descartar " +
                    "esta. </b> Si no has descartado ninguna, te quedas esta en tu mano y puedes usarla más adelante. " +
                    "<b> Obtienes la carta. </b> <i> Guárdala en tu mano o úsala. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Huyes a toda velocidad ante la situación, pero ves cómo tu alrededor no para de repetirse. " +
                    ...
                    "inerte en el suelo mustio mientras todo se nubla alrededor. <b> Pierdes una carta aleatoria de " +
                    "tu mano y también esta carta. </b> <i> Deja la carta aleatoria y esta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
            ...
            },
            {
                ...
                info: "Ignoras la petición y te pones a susurrar una nana que te cantaba tu madre para ahuyentar " +
                    ...
                    "limpias el sudor de la frente. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Decides ayudarla pero cuando te das cuenta de que las manchas no se van, no puedes moverte " +
                    "del sitio. La lavandera te ha pegado su maldición. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo " +
                    "de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Dices que tienes prisa y te vas. La lavandera intenta seguirte pero tu rapidez producida " +
                    "por el pánico te hace huir. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
    ...
    },
    {
        ...
        options: [
            {
                text: "Acabar el trabajo y comértelo",
                info: "El segundo conejo corre la misma suerte. Cuando solo quedan los huesos, los echas al fuego " +
                    ...
                    "del hambre hace que pierdas dos cartas. Puedes proseguir tu viaje... por ahora. <b> Pierdes dos " +
                    "cartas aleatorias de tu mano y también esta carta. </b> <i> Deja las cartas aleatorias y esta en el " +
                    "mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "La superstición te puede, dejas al conejo muerto y al vivo dentro de la madriguera. " +
                    ...
                    "lomo del animal. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Le haces el feo. Te mira muy enfadado y te bebe la sangre hasta dejarte sin una gota. " +
                    "<b> Pierdes cuatro cartas aleatorias de tu mano y también esta carta. </b> <i> Deja las cartas aleatorias " +
                    "y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Te das cuenta de que Rubí lleva mucho tiempo sin tener a nadie con quien jugar. Le dejas " +
                    ...
                    "sobrevivido una noche más. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Comienzas a correr por el camino por el que crees haber venido, pero tropiezas con un adoquín " +
                    ...
                    "<b> Pierdes una carta aleatoria de tu mano y también esta carta. </b> <i> Deja la carta aleatoria y esta en el " +
                    "mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Coges carrerilla y te lanzas hacia tu sombra, atravesándola, pero no te detienes: " +
                    ...
                    "vista atrás, ahí sigue tu sombra, con unos pequeños ojillos mansos y obedientes. <b> Obtienes " +
                    "la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Rompes el silencio con un grito, quizás por miedo, quizás por impulso. La figura se " +
                    ...
                    "como si nunca hubiera estado allí. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Te quedas inmóvil, casi sin respirar. Observas cómo la figura avanza lentamente, envuelta " +
                    ...
                    "olvidar. No haces ruido. No te mueves. La calma permanece. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Los caballos se acercan peligrosamente, pero no te dejas achantar e intentas amansarlos. " +
                    ...
                    "destartalada. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Intentas aprovecharte de la situación y, cuando te rebasa, tratas de agarrarte al carruaje. " +
                    ...
                    "desaparecido, pero te duele todo. <b> Pierdes una carta aleatoria de tu mano y también esta " +
                    "carta. </b> <i> Deja la carta aleatoria y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Te colocas en la trayectoria de los caballos, y estos cargan contra ti. En un movimiento " +
                    ...
                    "extraña sensación en el cuerpo. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "La situación te llena de terror, así que intentas salir de la encerrona. El caballo es veloz, " +
                    ...
                    "unos relinchos en la lejanía... <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
    ...
    },
    {
        ...
        options: [
            {
                text: "Lo ignoras",
                info: "El cadáver permanece a su suerte. <b> Pierdes la carta. </b> <i> Déjala en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Mientras estás cavando, se acerca un lobo que despedaza el cadáver. Cuando ya tienes " +
                    "el hoyo listo, te das cuenta de que ya no queda cuerpo que enterrar. <b> Pierdes la carta. " +
                    "</b> <i> Déjala en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "El fuego atrae a los animales cercanos, que se aproximan al cadáver. Finalmente, le has " +
                    ...
                    "mundo hostil. Sus cenizas te recordarán eternamente. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Consideras el pentagrama un símbolo diabólico, así que lo pisas para borrarlo, pero al poner " +
                    ...
                    "chamusca tu inventario. <b> Pierdes una carta aleatoria de tu mano y también esta carta. </b> <i> Deja la " +
                    "carta aleatoria y esta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Va un caracol y derrapa. Es tan sumamente malo que Antonio te devora con rabia. Toca esperar " +
                    "a que haga la digestión... Hasta que despiertas como si todo hubiera sido un sueño. <b> Pierdes la " +
                    "carta. </b> <i> Déjala en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "El chiste del chocobollo. La absurdez y plotwist del final le han pillado desprevenido y " +
                    ...
                    "<b> Pierdes una carta aleatoria de tu mano y obtienes esta carta. </b> <i> Deja la carta aleatoria en el " +
                    "mazo de descarte y guarda esta en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
            },
            {
                ...
                info: "Van dos y se cae el de enmedio. Antonio se parte de risa por tu manera de contarlo y debido " +
                    "a tu indiscutible carisma contando chorradas. Te deja ir sin rasguño alguno. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Al esqueleto le gusta la sopa tibia. La mención de la sopa despierta el apetito de Antonio, " +
                    ...
                    "sueño. <b> Pierdes la carta. </b> <i> Déjala en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Desentierras el ídolo por completo. Con paciencia y algo de esfuerzo, sacas el ídolo de " +
                    ...
                    "paga el precio.\". <b> Obtienes la carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Le das la mano a la criatura. Te arrastra hasta lo más profundo de la niebla. Despiertas " +
                    "donde estabas, con dolor de cabeza. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "No le das la mano. Das un paso atrás y te quedas sin moverte durante lo que parecen horas, " +
                    "hasta que la propia niebla se disipa. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
    ...
    },
    {
        ...
        options: [
            {
                text: "Te marchas",
                info: "No escuchas a la adivina, dudas que pueda ayudarte en tu viaje y pasas de largo. <b> Pierdes " +
                    "la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
            },
            {
                ...
                info: "Decides acercarte y escuchar lo que tiene que decir. La mujer te toma la mano y, con un " +
                    ...
                    "<b> Recupera una carta de evento que hubieses descartado y descarta esta. </b> Si no has descartado " +
                    "ninguna, te quedas esta en tu mano. <i> Continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "El barco pasa y vuelves a estar lejos del río. El individuo se quita el trapo, vislumbras un " +
                    ...
                    "sido respetuoso; una maldición rodea tu cuerpo. Lanza una moneda: <br> <b> Cara: </b> pierdes dos " +
                    "cartas. <br> <b> Cruz: </b> pierdes cuatro cartas. <i> Deja las cartas aleatorias y esta en el mazo de " +
                    "descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: true,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "El individuo se quita el trapo y vislumbras un ser esquelético, sin un ápice de músculo en " +
                    "su cuerpo, solo huesos. Te devuelve el saludo respetuoso y continúa su viaje. <b> Obtienes la " +
                    "carta. </b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Te sientas. Cuando vuelves a mirar, las sombras han desaparecido y comienzas a sentirte " +
                    "mejor. Ahora puedes continuar tu aventura con energías renovadas. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Apareces en un lugar completamente nuevo, aparentemente a salvo. Notas cómo una de las " +
                    ...
                    "te teletransportará, descartando la carta de evento peligrosa. <b> Obtienes la carta. " +
                    "</b> <i> Guárdala en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
            ...
            },
            {
                ...
                info: "Decides alejarte lo suficiente para no ser absorvido. Cuando miras atrás el marco ya no " +
                    "está. <b> Pierdes la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return false; },
                discard: () => { return true; },
        ...
        options: [
            {
                ...
                info: "Accedes, la cruz es tuya, pero todo tiene un precio. Deberás dejar una carta en el mazo " +
                    "de descarte. <b> Pierdes una carta a tu elección de tu mano y obtienes esta carta. </b> <i> Deja la carta " +
                    "elegida en el mazo de descarte y guarda esta en tu mano. Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
                discard: () => { return false; },
        ...
        options: [
            {
                ...
                info: "Llamas a los hermanos y les devuelves la moneda. Sus figuras se perfilan entre la niebla, " +
                    ...
                    "Recibes su agradecimiento con una leve reverencia. ¿Te servirá de algo? Quizá. <b> No obtienes " +
                    "la carta. </b> <i> Deja la carta en el mazo de descarte. Y continúas tu aventura donde estabas </i>.",
                dice: false,
                coin: false,
                save: () => { return false; },
            ...
            },
            {
                ...
                info: "Te guardas la moneda. Al contacto, el metal está frío, más de lo que debería. " +
                    ...
                    "su carga sin notarlo, hasta que es demasiado tarde. <b> Obtienes la carta. </b> <i> Guárdala en tu mano. " +
                    "Y continúas tu aventura donde estabas. </i>",
                dice: false,
                coin: false,
                save: () => { return true; },
